...
namespace Minecraft::Graphics
{
        ...
        : m_Window(window)
    {
        ...
        {
            ZoneScopedN("Create Tracy Context");
            g_TracyCTX = TracyWebGPUContext(m_Instance.Get(), m_Device.Get(), m_Queue.Get());
        }

        // Configure Surface & Depth Texture
        {
            ZoneScopedN("Configure Surface & Depth Texture");
